...
HD_PWD='G:/OExp_Summer/Summer_Project/Summer_Project.runs/RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source RAM.tcl
