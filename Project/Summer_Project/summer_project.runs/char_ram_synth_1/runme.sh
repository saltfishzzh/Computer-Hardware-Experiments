...
HD_PWD='C:/Users/Jerry Chang/Desktop/Summer_Project/summer_project.runs/char_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log char_ram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source char_ram.tcl
