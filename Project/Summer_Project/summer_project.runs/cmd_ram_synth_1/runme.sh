...
HD_PWD='C:/Users/Jerry Chang/Desktop/Summer_Project_test/summer_project.runs/cmd_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmd_ram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cmd_ram.tcl
